...
int partition(int a[], int left, int right, int pivotIndex) {
	...
	// elements < pivot move to the left of `pIndex`;
	// elements > pivot move to the right of `pIndex`;
	...
	// move pivot to the correct place in the middle
	swap(a[pivotIndex], a[right]);
	return pivotIndex; // return location of the pivot
}
